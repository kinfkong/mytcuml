...
/**
 * <p>
 * Tests for adding, removing, and persistence for send signal message edge.
 * </p>
 * @author ly
 * @version 1.0
 */
public class SendSignalMessageEdgeTest extends EdgeTest {
    ...
    protected void setUp() throws Exception {
        ...
        super.setType(SendSignalMessageEdge.class);
        super.setUp();
    }
}
