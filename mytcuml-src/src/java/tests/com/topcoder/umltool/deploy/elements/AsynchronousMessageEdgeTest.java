...
/**
 * <p>
 * Tests for adding, removing, and persistence for asynchronous message edge.
 * </p>
 * @author ly
 * @version 1.0
 */
public class AsynchronousMessageEdgeTest extends EdgeTest {
    ...
    protected void setUp() throws Exception {
        ...
        super.setType(AsynchronousMessageEdge.class);
        super.setUp();
    }
}
