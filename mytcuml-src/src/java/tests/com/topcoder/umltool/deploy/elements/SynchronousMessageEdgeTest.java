...
/**
 * <p>
 * Tests for adding, removing, and persistence for synchronous message edge.
 * </p>
 * @author ly
 * @version 1.0
 */
public class SynchronousMessageEdgeTest extends EdgeTest {
    ...
    protected void setUp() throws Exception {
        ...
        super.setType(SynchronousMessageEdge.class);
        super.setUp();
    }
}
