...
/**
 * Failure tests for OrderingPropertyPanel class.
 *
 * @author Yeung
 * @version 1.0
 */
public class OrderingPropertyPanelFailureTests extends TestCase {
    /**
     * Tests the constructor OrderingPropertyPanel(PropertiesPanel) with null propertiesPanel, expected
