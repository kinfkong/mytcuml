...
/**
 * Failure tests for ChildLinkPropertyPanel class.
 *
 * @author Yeung
 * @version 1.0
 */
public class ChildLinkPropertyPanelFailureTests extends TestCase {
    /**
     * Tests the constructor ChildLinkPropertyPanel(PropertiesPanel) with null propertiesPanel, expected
