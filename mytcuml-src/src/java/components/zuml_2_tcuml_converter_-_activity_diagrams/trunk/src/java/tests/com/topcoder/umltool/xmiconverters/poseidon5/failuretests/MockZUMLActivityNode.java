...
/**
 * <p>
 * Mock implementation of <code>AbstractZUMLActivityNode</code> class. It provides an empty implementation of
 * convertToTCUML(). It's just used for testing <code>AbstractZUMLActivityNode</code> class.
 * </p>
 * 
 * @author iRabbit
 * @version 1.0
