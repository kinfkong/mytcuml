...
/**
 * Dummy implementation of the ModelElement class. It is used as a base for other classes
 * that implement this interface.
 * @author kr00tki
 * @version 1.0
 */
public class DummyModelElement implements ModelElement {
	...
	public void addTemplateParameter(int index,
	...
	public void setTemplateParameter(int index,
			TemplateParameter templateParameter) {
	}
