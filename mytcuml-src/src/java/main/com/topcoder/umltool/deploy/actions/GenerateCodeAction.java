...
public class GenerateCodeAction extends AbstractAction {
    ...
    private class GenerateCodeDialog extends JDialog {
        ...
        private void traverse(CheckNode parentNode, ModelElement element) {
            ...
            if ((element instanceof ClassImpl || (element instanceof InterfaceImpl))&& element.getTaggedValues().size() > 0) {
            	childTreeNode.setSelected(true);
            	//((DefaultTreeModel) classTree.getModel()).nodeChanged(childTreeNode);
            }
        }
